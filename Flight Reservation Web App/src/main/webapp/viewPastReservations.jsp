...
<%
	...
	PreparedStatement ps2 = con.prepareStatement("select flightNumber, airlineID, seatNum, departure_time from ticketstatus where username = ? AND departure_time < NOW()"); 
