...
<html>
<head>
<title>List of Reservations By Flight Number</title>
</head>
<html>

<%
	String flightNumber = request.getParameter("flightNumberReserve");
	String airlineID = request.getParameter("airlineIDReserve");	
	...
	Connection con = db.getConnection();
	  ...
	  if (rs.next()) {
	    ...
	    out.println("No reservations found for AirlineID: " + airlineID + " Flight Number: " + flightNumber + ", Please <a href='adminHome.jsp'>try again</a>");
	  }
%>